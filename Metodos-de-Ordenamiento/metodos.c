...
void 
imprimirResultados( double utime0, double stime0, double wtime0, double utime1, double stime1, double wtime1, int n )
{
	FILE* resultados;
	resultados = fopen("/home/ivanovsky/Algorythms-Analisis/Sort-Methods/resultados.txt", "w");
